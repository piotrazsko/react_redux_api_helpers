...
var _temp = function () {
	...
	__REACT_HOT_LOADER__.register(internalUrl, 'internalUrl', 'src/configs/__tests__/apiLocations.test.js');

	__REACT_HOT_LOADER__.register(externalUrl, 'externalUrl', 'src/configs/__tests__/apiLocations.test.js');

	__REACT_HOT_LOADER__.register(httpsUrl, 'httpsUrl', 'src/configs/__tests__/apiLocations.test.js');
}();
